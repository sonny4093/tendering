                        ...
                        <div class="main-body">
                            <div class="page-wrapper">
                                <div class="page-body">
                                    <div class="row">
                                        <div class="col-sm-16">
                                            <div  class="card" style="width:600px; overflow-x: scroll;">
                                                <div class="card-header">
                                                    <h5><div class="allusers">
        <h3 style="font-size: 18px;"><w>Please the reason why you need to cancel the tender</h3>
   <!--  <?php include("");
    ?> -->
    </div></h5>
                                                <p><?php
		include ("../php/cancelTender.php");
	 ?>


	 <div class="form">
			<form action="cancelTender.php" method="post" enctype="multipart/form-data">
					
					<div class="form1"><br>
					<input type="hidden" name="id" value="<?php echo $_REQUEST['id'];?>"><br>
						<label>Reason</label>
						<textarea required="" placeholder="Please whrite you reason" class="form-control" name="reason" style="width: 400px; height: 200px;"></textarea><br><br>	
						...
						<input style="height: 30px;" id="cancel" type="reset" name="cancel" value="Cancel"><br><br><br>
					</div>
			</form>
