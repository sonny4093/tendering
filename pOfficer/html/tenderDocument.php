...
<div id="pcoded" class="pcoded">
    <div class="pcoded-overlay-box"></div>
        ...
        <h3 style="font-size: 18px;"><w>Upload tender document</h3>
   <!--  <?php include("");
    ?> -->
    </div></h5>
                                                <p><?php
		include ("../php/tenderDocument.php");
	 ?>
                                           	...
                                           	<form action="tenderDocument.php" method="post" enctype="multipart/form-data">
                                                    	<input type="hidden" name="id" value="<?php echo $row1['id'];?>">
                                                            <div class="form-group form-default">
                                                    	        	<label class="float-label">Choose File</label><br>
                                                    	        	<input  type="file" name="myfile" required >
                                                                
                                                                <span class="form-bar"></span>
                                                                
                                                            </div>
						<input class="btn btn-primary btn-round waves-effect waves-light" id="submit" type="submit" name="save" value="Submit"><w><w><w>
						<input class="cancel" style="height: 30px;" id="cancel" type="reset" name="cancel" value="Cancel"></form>
