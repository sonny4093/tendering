                        ...
                        <div class="main-body">
                            <div class="page-wrapper">
                                <div class="page-body">
                                    <div class="row">
                                        <div class="col-sm-16">
                                            <div class="card" style="float: right;align-content: center;">
                                                <div class="card-header" style="float: right;align-content: center;">
	 ...
	 <div class="form">
			<form action="feedback.php" method="post" enctype="multipart/form-data">
					...
					<input type="hidden" name="id" value="<?php echo $_REQUEST['id'];?>"><br>
						<label>Please leave your feedback</label><br>
						<textarea required="" placeholder="feedback" class="form-control" name="feedback" style="width: 400px; height: 200px;"></textarea><br><br>	
